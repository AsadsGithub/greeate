...
export default function GreeateRegister() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#A8B5FF] via-[#8B7FD9] to-[#6B46C1] p-6">
            <div className="w-full max-w-md rounded-2xl bg-white/80 p-8 shadow-xl dark:bg-slate-800/80">
                <Head title={t('create_account', 'Register')} />
                <h1 className="mb-6 text-2xl font-bold">{t('create_account', 'Create account')}</h1>
                <Form action="/register" method="post" className="space-y-4">
                    ...
                    <Button type="submit" className="w-full">{t('create_account', 'Create account')}</Button>
                </Form>
